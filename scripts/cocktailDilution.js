function cocktailDilution(initialAbvPercent, prepMethods) {
  ...
  function stir() { -1.21 * Math.pow(initialAbv, 2) + 1.246 * initialAbv + 0.145; }
  function shake() { -1.567 * Math.pow(initialAbv, 2) + 1.742 * initialAbv + 0.203; }
  const dilution = {
    'Stir': stir() ,
    'Stir on Big Rock': stir(),
    'Shake': shake(),
    'Short Shake': shake() * 0.75,
    'Dirty Dump': shake(),
    'Build': 0,
    'Dry Shake': 0,
    'Slushy': 0,
