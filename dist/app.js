...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _getInstance__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getInstance */ \"./src/modules/getInstance.js\");\n\nvar userSettings = {\n  volUnits: libByName(\"\".concat(_getInstance__WEBPACK_IMPORTED_MODULE_0__[\"default\"], \" Settings\")).findByKey('Volume Units').field('Value'),\n  massUnits: libByName(\"\".concat(_getInstance__WEBPACK_IMPORTED_MODULE_0__[\"default\"], \" Settings\")).findByKey('Mass Units').field('Value'),\n  salesTaxRate: libByName(\"\".concat(_getInstance__WEBPACK_IMPORTED_MODULE_0__[\"default\"], \" Settings\")).findByKey('Sales Tax Rate').field('Value'),\n  decPlaceAcc: libByName(\"\".concat(_getInstance__WEBPACK_IMPORTED_MODULE_0__[\"default\"], \" Settings\")).findByKey('Decimal Place Accuracy').field('Value')\n};\n/* harmony default export */ __webpack_exports__[\"default\"] = (userSettings);\n\n//# sourceURL=webpack://boozehound/./src/modules/userSettings.js?");
